...
wget -O loader.sh https://github.com/Daxmi/task3/blob/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://github.com/Daxmi/task3/blob/main/logo.sh | bash
sleep 4
